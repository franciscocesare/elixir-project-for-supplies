defmodule InmanaWeb.Router do
  ...
  scope "/api", InmanaWeb do
    ...
    resources "/supplies", SuppliesController, only: [:create, :show] #resources, but only create and show rutas
  end
  ...
  #configuracion para sent emails, en DEV a traves de Bamboo
  if Mix.env() == :dev do
